...
namespace SFC.Tests.Notification
{
    ...
    public class NotificationServiceTests
  {
    ...
    public void SendNotificationTest()
    {
      ...
      var query = _container.Resolve<INotificationPerspective>();
      ...
      IEnumerable<NotificationsCountResult> result = query.GetSendNotificationsCount(notificationType, loginName);
