...
{
  internal class SendNotificationHandler : ICommandHandler<SendNotificationCommand>, IEventHandler<AlertCreatedEvent>
  {
    ...
    {
      Handle(new SendNotificationCommand() { Body = "Alert Created hurey", Title = "AlertCreated", LoginName = ev.LoginName, NotificationType = "AlertCreated" });
    }
  }
}